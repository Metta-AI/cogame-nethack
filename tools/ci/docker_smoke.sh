...
# Substitute: nethack, coworld-nethack, 1.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-nethack:ci)
#   SMOKE_SLUG                 game slug                        (nethack)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/nethack)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/nethack-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-nethack:ci}}"
slug="${SMOKE_SLUG:-nethack}"
